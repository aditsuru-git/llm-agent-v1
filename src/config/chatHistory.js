export const chatHistory = [
  ...
  {
    role: "user",
    parts: [{ text: "Can you read the 'readme.md' file for me?" }],
  },
  {
    role: "model",
  ...
  {
    role: "user",
    parts: [{ text: "Wait, wait, one more time—read the file." }],
  },
  {
    role: "model",
    parts: [
  ...
  },
  {
    role: "user",
    parts: [
      { text: "Alright, now it should work. Try reading the file again." },
    ],
  },
  {
    role: "model",
  ...
  {
    role: "user",
    parts: [{ text: "Heh, my bad. Anyway, how ya doin'?" }],
  },
  {
    role: "model",
    parts: [
  ...
  {
    role: "user",
    parts: [{ text: "Oh yeah? How’s that going?" }],
  },
  {
    role: "model",
    parts: [
  ...
  {
    role: "user",
    parts: [{ text: "*goes offline for plenty of hours*" }],
  },
];
